...
<body>
  ...
  <div class="navbar">
    <div class="brand">
      <img src="./assets/csir_cftri_logo.jpg" alt="CFTRI Logo" style="width: 60px">
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-2 sidebar p-0">
        ...
        <a href="admin_sections/quarters.php" target="contentFrame">
          <i class="fa-solid fa-building"></i> Quarters
        </a>
        <a href="admin_sections/employees.php" target="contentFrame">
        ...
        <div class="stats-row">
          <div class="stat-card">
            <div class="d-flex justify-content-between align-items-center">
              <div>
                <div class="stat-title"><a href="admin_sections/quarters.php" style="color: inherit; text-decoration: none;">Total Quarters</a></div>
