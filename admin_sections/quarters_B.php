...
// Fetch only quarters where 'quarter_no' contains 'B' (case-insensitive)
$sql = "SELECT * FROM quarters WHERE quarter_no LIKE '%B%'";
...
<head>
<meta charset="UTF-8">
<title>Type B Quarters | CFTRI Management</title>
...
<h4 class="mt-3">Type B Quarters</h4>
