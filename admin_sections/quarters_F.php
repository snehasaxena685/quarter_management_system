...
// Fetch only quarters where 'quarter_no' contains 'F' (case-insensitive)
$sql = "SELECT * FROM quarters WHERE quarter_no LIKE '%F%'";
...
<head>
<meta charset="UTF-8">
<title>Type F Quarters | CFTRI Management</title>
...
<h4 class="mt-3">Type FA0 Quarters</h4>
...
<table class="table table-bordered table-striped mt-3">
  ...
  <tbody>
    <?php if ($result && $result->num_rows > 0): ?>
      ...
      <?php endwhile; ?>
    <?php else: ?>
      <tr><td colspan="5" class="text-center text-muted">No Type B quarters found.</td></tr>
    <?php endif; ?>
  </tbody>
</table>
